...
function Footer() {
    ...
    const datInfo = `© 2017–${nowYear} third example`
    return (
        <footer className="pt-4 my-md-5 pt-md-5 border-top">
            ...
            <div className="col-12 col-md">
                ...
                {/* <small className="d-block mb-3 text-body-secondary">© 2017–{nowYear}</small> */}
                {/* <small className="d-block mb-3 text-body-secondary">{datInfo}</small> */}
